namespace Threadlink.Templates.CameraUtilities
{
	...
	internal sealed class SmoothFollowAnchor : LinkableBehaviour, IBootable
	{
		[Flags]
		...
		public void Boot()
		{
			if (followTarget != null) Propagator.Subscribe<Action>(PropagatorEvents.OnUpdate, Follow);
		}
		...
		public void DetachFromParent()
		{
			...
			if (options.HasFlagUnsafe(Options.DontDestroyOnLoad)) DontDestroyOnLoad(gameObject);
		}
	}
}